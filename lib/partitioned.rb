#require 'activerecord_monkey_patches/base'
#require 'activerecord_monkey_patches/connection_adapters/abstract/schema_definitions'
#require 'activerecord_monkey_patches/connection_adapters/postgresql_adapter'
#require 'activerecord_monkey_patches/model_schema'
#require 'activerecord_monkey_patches/persistence'
#require 'activerecord_monkey_patches/relation'

require 'partitioned/bulk_methods_mixin'
require 'partitioned/partitioned_base/configurator'
