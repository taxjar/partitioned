          ...
          unless @using_configurators
            ...
            using_classes.each do |using_class|
              using_class.ancestors.each do |ancestor|
                ...
                @using_configurators << UsingConfigurator.new(using_class, ancestor, ancestor::configurator_dsl) if ancestor.respond_to?(:configurator_dsl) && ancestor::configurator_dsl
